...
namespace api.Controllers
{
    public static class ApiResponse
    {
        ...
        public static IActionResult Updated<T>(T data, string message = "Resource Updated")
        {
            return new ObjectResult(new ApiResponseTemplate<T>(true, data, message, 204));
        }

        public static IActionResult Deleted<T>(T data, string message = "Resource Deleted")
        {
            return new ObjectResult(new ApiResponseTemplate<T>(true, data, message, 204));
        }
